...
export const ui = {
  en: {
    ...
    'nav.blog': 'Blog',
    'nav.blog.href': '/blog',
    'nav.products.kurippa.href': '/products/kurippa',
    'nav.products.vaultz.href': '/products/vaultz',
    'nav.lang': '🇯🇵',
    'nav.lang.href': '/ja/',
    'blog.eyebrow': 'Blog',
    'blog.heading': 'Notes from the forge',
  ...
  ja: {
    ...
    'nav.blog': 'ブログ',
    'nav.blog.href': '/ja/blog',
    'nav.products.kurippa.href': '/ja/products/kurippa',
    'nav.products.vaultz.href': '/ja/products/vaultz',
    'nav.lang': '🇺🇸',
    'nav.lang.href': '/',
    'blog.eyebrow': 'ブログ',
    'blog.heading': '工房からのノート',
    'blog.empty': 'まだ記事はありません — またお越しください。',
    'blog.back': '← 記事一覧へ',
    'blog.published': '公開日',
    'blog.updated': '更新日',
    'blog.author.by': '著者:',
    'blog.readingTime': '{n}分',
    'blog.alsoOn': '他のサイト:',
